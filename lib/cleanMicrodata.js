...
module.exports = function (mdata, callback) {
  ...
  //traverse();
  // iterate thru all of mdata collection
  // if we find an object that has both a key named "type"
  // and a key named "properties", then we want to grab
  // the "type"[0] - which is the value of the first object
  // within the type array.
  // else nothing.
